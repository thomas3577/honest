...
export function ApiOperation(options: ApiOperationOptions): MethodDecorator {
  return (_value, context) => {
    ...
    const meta: ApiOperationMetadata = { functionName: context.name, ...options };
...
export function ApiResponse(options: ApiResponseOptions): MethodDecorator {
  return (_value, context) => {
    ...
    const meta: ApiResponseMetadata = { functionName: context.name, ...options };
...
export function ApiExcludeEndpoint(): MethodDecorator {
  return (_value, context) => {
    ...
    const meta: ApiOperationMetadata = { functionName: context.name, excluded: true };
